"""Cutting a region out of a page, straightened.

A detected region is a polygon on a scanned page, so it is neither
axis-aligned nor rectangular. Where the polygon is close enough to a
quadrilateral, it is unwarped onto one; otherwise it is masked and cut to
its bounding box.
"""
